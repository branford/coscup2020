...
10.140.0.$master_ip coscup-$username-failover-1.c.pixnet-system-admin.internal coscup-$username-failover-1  # Added by Google
10.140.0.$backup_ip coscup-$username-failover-2.c.pixnet-system-admin.internal coscup-$username-failover-2  # Added by Google
169.254.169.254 metadata.google.internal  # Added by Google

10.140.0.$master_ip coscup-$username-failover-1
10.140.0.$backup_ip coscup-$username-failover-2
